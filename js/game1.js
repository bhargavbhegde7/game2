...
var pos = 0, pos2 = 590, pos4 = 800, mbox, stop = true, duration =
  10 /*0.5 */ , increment = 4 /*0.4 */ , up = false, down = false, hits =
  0, count = 0, level = 1, mHits = 0, hitIncrement = true, left =
  false, right = false;
...
function startMove () 
{
	...
	write
	(" you have crossed the maximum number of hits (3) in a single level. game over ");
      document.write (" summary: tries= " + count + " total hits= " + hits +
		       " last level " + level +
...
case "b1":
		...
		{
		document.getElementById ("myPlayer1").src =
		"images/2hits.png";}
